...
- Nama dan NIM: Muhammad Zaim El Yafi (24090064)
...
css/style.css - Styling sederhana responsif (Flex/Grid, cards, table)
js/script.js - Data dummy (summary & products) dan script tiap halaman
assets - folder untuk menyimpan file gambar
